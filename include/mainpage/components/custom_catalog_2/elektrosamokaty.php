...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"TITLE" => "Время кататься на электросамокате",
		...
		"SHOW_SECTION" => "Y",
		"COUNT_IN_LINE" => "4",
		"RIGHT_LINK" => "/catalog/sport-i-otdykh/elektrotransport/elektrosamokaty/",
		...
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBSection\",\"DATA\":{\"logic\":\"Equal\",\"value\":85}}]}",
		"SHOW_TABS" => "N"
	),
	false
);?>