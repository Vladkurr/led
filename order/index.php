...
?><?if (TSolution::isSaleMode()):?>
	...
	Array(
		...
		"PRODUCT_COLUMNS" => "",
		"PRODUCT_COLUMNS_HIDDEN" => array("PREVIEW_PICTURE","DETAIL_PICTURE","PREVIEW_TEXT","PROPS","NOTES","DISCOUNT_PRICE_PERCENT_FORMATED","PRICE_FORMATED"),
		"PRODUCT_COLUMNS_VISIBLE" => array("PREVIEW_PICTURE","PROPS","NOTES","DISCOUNT_PRICE_PERCENT_FORMATED","PRICE_FORMATED"),
		"PROPS_FADE_LIST_1" => array("4","5","6"),
		"PROPS_FADE_LIST_2" => array("8","9","10","11","12","13"),
		"PROPS_FADE_LIST_5" => "",
		"PROPS_FADE_LIST_6" => "",
		"PROP_1" => "",
		"PROP_2" => "",
		...
		"SHOW_MAP_FOR_DELIVERIES" => array("4","5"),
		"SHOW_MAP_IN_PROPS" => "Y",
