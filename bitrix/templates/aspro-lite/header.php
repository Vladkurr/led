...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?=LANGUAGE_ID?>" lang="<?=LANGUAGE_ID?>" class="<?=($_SESSION['SESS_INCLUDE_AREAS'] ? 'bx_editmode ' : '')?><?=strpos( $_SERVER['HTTP_USER_AGENT'], 'MSIE 7.0' ) ? 'ie ie7' : ''?> <?=strpos( $_SERVER['HTTP_USER_AGENT'], 'MSIE 8.0' ) ? 'ie ie8' : ''?> <?=strpos( $_SERVER['HTTP_USER_AGENT'], 'MSIE 7.0' ) ? 'ie ie9' : ''?>">
	<head>
        ...
        <?$APPLICATION->SetPageProperty("Title", "Ledspro - Интернет магазин светодиодных лент и светильников"); ?>
        <?$APPLICATION->SetPageProperty("Description", "Ledspro - Интернет магазин светодиодных лент и светильников"); ?>
        <?$APPLICATION->SetPageProperty("og:title", "Ledspro - Интернет магазин светодиодных лент и светильников"); ?>
        <?$APPLICATION->SetPageProperty("og:type", "website"); ?>
        <?$APPLICATION->SetPageProperty("og:url", "https://ledspro.ru/"); ?>
        <?$APPLICATION->SetPageProperty("og:image", "https://ledspro.ru/upload/CLite/9ad/js5nysxplheo0onxuu16u7nt9s8ushtw.png"); ?>
