										...
										<?if($ar["VALUE"]){?>
											<div class="line-block__item">
												...
												<div class="pict">
													...
													?>
													<label for="<?=$ar["CONTROL_ID"]?>" data-role="label_<?=$ar["CONTROL_ID"]?>" class="sku-props__value sku-props__value--pict lazyload <?=$class?>" title="<?=$ar["VALUE"];?>" onclick="smartFilter.keyup(BX('<?=CUtil::JSEscape($ar["CONTROL_ID"])?>')); BX.toggleClass(this, 'active');" data-bg="<?=((isset($ar["FILE"]) && !empty($ar["FILE"]["SRC"])) ? $ar["FILE"]["SRC"] : SITE_TEMPLATE_PATH.'/images/noimage.png');?>"></label>
												</div>
												<?$j++;?>
											</div>
										<?}?>
