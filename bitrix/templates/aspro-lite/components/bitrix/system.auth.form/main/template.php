        ...
        <div id="ajax_auth<?= $rand ?>" class="auth-page pk-page">
            <div class="auth form-block">
                <div class="form <?= ($arParams['POPUP_AUTH'] === 'Y' ? 'popup' : '') ?> <?= ($arResult['SHOW_SMS_FIELD'] ? 'form--send-sms' : '') ?>">
                    ...
                    <form id="auth-page-form<?= $rand ?>" name="system_auth_form<?= $arResult['RND'] ?>" method="post"
                        ...
                        <input type="hidden" name="POPUP_AUTH"
                               value="<?= ($arParams['POPUP_AUTH'] === 'Y' ? 'Y' : 'N') ?>"/>
                        ...
                        <div class="form-body">
                            ...
                            <? if ($arResult['PHONE_AUTH_PARAMS']['USE']): ?>
                                <? if ($arResult['SHOW_SMS_FIELD']): ?>
                                    ...
                                    <div class="form-group fill-animate phone_code">
                                        <label for="SMS_CODE_POPUP<?= $rand ?>"><span><?= GetMessage('auth_sms_code') ?>&nbsp;<span
                                                        class="required-star">*</span></span></label>
                                        <div class="input">
                                            <input type="text" name="SMS_CODE" id="SMS_CODE_POPUP<?= $rand ?>"
                                ...
                                <? else: ?>
                                    <div class="form-group fill-animate phone_or_login">
                                        <label for="AUTH_PHONE_OR_LOGIN<?= $rand ?>"
                                               class="font_14"><span><?= GetMessage('auth_phone_number_or_login') ?>&nbsp;<span
                                                        class="star">*</span></span></label>
                                        <div class="input">
                                            <input id="AUTH_PHONE_OR_LOGIN<?= $rand ?>" class="form-control required"
                                                   type="text" name="AUTH_PHONE_OR_LOGIN" maxlength="50"
                                                   autocomplete="off" value="" tabindex="1"/>
                                    ...
                                    <div class="form-group fill-animate">
                                        <label for="USER_PASSWORD_POPUP<?= $rand ?>"
                                               class="font_14"><span><?= GetMessage('auth_password2') ?>&nbsp;<span
                                                        class="required-star">*</span></span></label>
                                        <div class="input">
                                            <input type="password" name="USER_PASSWORD"
                                                   id="USER_PASSWORD_POPUP<?= $rand ?>"
                            ...
                            <? else: ?>
                                <div class="form-group fill-animate" data-sid="USER_LOGIN_POPUP">
                                    <label class="font_14"
                                           for="USER_LOGIN_POPUP<?= $rand ?>"><span><?= GetMessage("AUTH_LOGIN") ?> <span
                                                    class="required-star">*</span></span></label>
                                    <div class="input">
                                ...
                                <div class="form-group fill-animate" data-sid="USER_PASSWORD_POPUP">
                                    <label class="font_14"
                                           for="USER_PASSWORD_POPUP<?= $rand ?>"><span><?= GetMessage("AUTH_PASSWORD") ?> <span
                                                    class="required-star">*</span></span></label>
                                    <div class="input">
                                        <input type="password" name="USER_PASSWORD" id="USER_PASSWORD_POPUP<?= $rand ?>"
                                               class="form-control required" maxlength="50" value="" autocomplete="on"
                                               tabindex="2"/>
                                    </div>
                                </div>
                            <? endif; ?>
                            ...
                            <? if ($arResult["CAPTCHA_CODE"]): ?>
                                ...
                                <div class="form-control captcha-row clearfix">
                                    <label for="FORGOTPASSWD_CAPTCHA<?= $rand ?>"
                                           class="font_14"><span><?= (TSolution\ReCaptcha::checkRecaptchaActive() ? GetMessage("FORM_GENERAL_RECAPTCHA") : GetMessage("CAPTCHA_PROMT")) ?>&nbsp;<span
                                                    class="required-star">*</span></span></label>
                                    ...
                                    <div class="captcha_input">
                                        <input id="FORGOTPASSWD_CAPTCHA<?= $rand ?>" type="text"
                                               class="inputtext form-control captcha" name="captcha_word" size="30"
                        ...
                        <div class="form-footer auth__bottom <?= ($arResult['SHOW_SMS_FIELD'] ? 'hidden' : '') ?>">
                                    ...
                                    <div class="line-block__item">
                                        <div class="prompt remember pull-left form-checkbox">
                                            <input type="checkbox" class="form-checkbox__input"
                                                   id="USER_REMEMBER_frm<?= $rand ?>" name="USER_REMEMBER" value="Y"
                                                   tabindex="5"/>
                                            <label for="USER_REMEMBER_frm<?= $rand ?>" tabindex="5"
                            ...
                            <div class="auth__bottom-btns">
                                <div class="line-block line-block--align-normal line-block--16-vertical flexbox--direction-column flexbox--justify-beetwen">
                                    <? if ($arResult['PHONE_AUTH_PARAMS']['USE']): ?>
                                        <div class="line-block__item btns-login">
                                        <? if ($arResult['SHOW_SMS_FIELD']): ?>
                                            <button class="btn btn-default btn-lg btn-wide" type="submit" name="Login1"
                                                    value="Y" tabindex="2">
                                                <span><?= GetMessage('AUTH_LOGIN_BUTTON') ?></span></button>
                                        <? else: ?>
                                            <button class="btn btn-default btn-lg btn-wide" type="submit" name="Login1"
                                                    value="Y" tabindex="2">
                                                <span><?= GetMessage('auth_password_continue') ?></span></button>
                                            <button class="btn btn-default btn-lg btn-wide hidden" type="submit"
                                                    name="Login1" value="Y" tabindex="2">
                                                <span><?= GetMessage('AUTH_LOGIN_BUTTON') ?></span></button>
                                            <button class="btn btn-default btn-lg btn-wide hidden" type="submit"
                                                    name="Login1" value="Y" tabindex="2">
                                            ...
                                            <div class="line-block__item">
                                            <!--                                            <a href="--><?php //= $arResult['AUTH_REGISTER_URL']; ?><!--"-->
                                            <!--                                                             rel="nofollow"-->
                                            <!--                                                             class="btn btn-default btn-transparent btn-lg btn-wide auth__bottom-btn register"-->
                                            <!--                                                             tabindex="6">--><?php //= GetMessage('AUTH_REGISTER_NEW') ?><!--</a>-->
                                        <? endif; ?>
                                        </div>
                                    <? else: ?>
                                        <div class="line-block__item">
                                            <button type="submit"
                                                    class="btn btn-default btn-lg btn-wide auth__bottom-btn"
                                                    name="Login1" value="" tabindex="4">
                                        ...
                                        <? if (\Bitrix\Main\Config\Option::get('main', 'new_user_registration', 'N', NULL) == 'Y'): ?>
                                            <div class="line-block__item">
                                                ...
                                                <a href="<?= $arResult["AUTH_REGISTER_URL"]; ?>" rel="nofollow"
                                                   class="btn btn-default btn-transparent btn-lg btn-wide auth__bottom-btn"
                                                   tabindex="6">
                            ...
                            <? if (COption::GetOptionString("aspro.lite", "SHOW_LICENCE", "N") == "Y"): ?>
                                <div class="licence_block">
                                    ...
                                    <input type="checkbox" id="licenses_auth<?= $rand ?>" name="licenses_popup" checked
                                           required value="Y" class="form-checkbox__input">
                                </div>
                            <? endif; ?>
                        </div>
                    </form>
                    <button class="btn btn-default btn-wide has-ripple btn-ok" name="OK"
                            value="Y" tabindex="2" style="display: none">OK
                    </button>
                    <? if ($arResult['SHOW_SMS_FIELD']): ?>
                ...
                //                $rsUsers = CUser::GetList($order, $tmp, ["PERSONAL_PHONE" => "+7 (989) 282-53-95"])->GetNext();
                //                echo "<pre>";
                //                var_dump($rsUsers["PERSONAL_PHONE"]);
                //                echo "</pre>";
                //                ?>
                <script>
                    ...
                    $(document).ready(function () {
                        ...
                        document.addEventListener("click", (e) => {
                            if(e.target.classList.contains("btn-ok")) window.location.replace(`https://ledspro.ru/auth/registration/?SMS=Y&PHONE=${window.phone}`);
                        })
                        function checkCaptcha(sid, value) {
                            $.ajax({
                                url: `/ajax/check-captcha.php?captcha_word=${value}&captcha_sid=${sid}`,
                                dataType: 'json',
                                data: {},
                                type: 'POST',
                                success: function (offerResponse) {
                                    window.captcha = offerResponse;
                                }
                            })
                        }
                        document.querySelector(".btns-login").addEventListener("click", (e) => {
                            window.captcha = true;
                            if (e.target.closest(".btn-lg")) {
                                if(document.querySelector(".captcha-row")){
                                    let captchaSid = document.querySelector(".captcha-row").querySelector(".captcha_sid").value;
                                    let captchaWord = document.querySelector(".captcha-row").querySelector(".captcha").value;
                                    checkCaptcha(captchaSid, captchaWord);
                                }

                                let phone = document.querySelector("[name='AUTH_PHONE_OR_LOGIN']")?.value;
                                phone = phone.replace(/\(/, "");
                                phone = phone.replace(/\)/, "");
                                ...
                                function redirect() {
                                    if (window.captcha) {
                                        ...
                                        $.ajax({
                                            ...
                                            type: 'POST',
                                            success: function (offerResponse) {
                                                if (offerResponse != phone) {
                                                    console.log(2)
                                                    document.querySelector(".phone_or_login")?.remove()
                                                    document.querySelector(".captcha-row")?.remove()
                                                    document.querySelector(".auth__bottom-action")?.remove()
                                                    document.querySelector(".auth__bottom")?.remove()
                                                    document.querySelector(".form-group")?.remove()
                                                    document.querySelector(".btn-ok").style = "display: block; width: 50%;margin: 0 auto 20px !important;"
                                                }
                                            }
