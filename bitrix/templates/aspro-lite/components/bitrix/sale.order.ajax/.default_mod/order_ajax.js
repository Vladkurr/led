	...
	BX.Sale.OrderAjaxComponent = {
		...
		init: function(parameters)
		{
			...
			if(this.activeSectionId){
				this.show(BX(this.activeSectionId));
				BX.addClass(BX(this.activeSectionId), 'bx-selected');
			}
			// this.initFirstSection();
		...
		initFirstSection: function()
		{
			...
			// var firstSection = this.propsBlockNode.querySelector('.bx-soa-section.bx-active');
			BX.addClass(firstSection, 'bx-selected');
			this.activeSectionId = firstSection.id;
			console.log('initFirstSection');
		...
		{
			console.log('--show');
			console.log('this.activeSectionId', this.activeSectionId);
