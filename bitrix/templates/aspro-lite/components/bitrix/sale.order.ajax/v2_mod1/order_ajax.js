...
(function () {
  ...
  BX.Sale.OrderAjaxComponent = {
    ...
    init: function (parameters) {
      ...
      this.activeSectionIdFirst = 'bx-soa-properties';

      if(this.activeSectionIdFirst){
        this.show(BX(this.activeSectionIdFirst));
        BX.addClass(BX(this.activeSectionIdFirst), 'bx-selected');
      }
    },
