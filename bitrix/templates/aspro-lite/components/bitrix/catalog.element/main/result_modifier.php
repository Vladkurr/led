...
//	echo "<pre>"; var_dump($arParams['OFFERS_CART_PROPERTIES']); echo "</pre>";
...
foreach ($arResult["PROPERTIES"] as $key => &$prop){
	if(!$prop["VALUE"]) unset ($arResult["PROPERTIES"][$key]);
	$prop["DISPLAY_VALUE"] =  $prop["VALUE"];
}
// вывод характеристик элемента
...
// вывод характеристик элемента
	...
	$arResult['CHARACTERISTICS'] = $arResult['PROPERTIES'];
