...
//        }
        ...
        <div class="sections-block <?= $mainClasses ?> <?= $templateName ?>-template">
            ...
            <div class="maxwidth-theme">
                <? endif; ?>
                <div class="grid-list  grid-list--fill-bg grid-list--items-22" style="grid-template-columns: repeat(auto-fill, minmax(150px, 1fr));">
                    ...
                    foreach ($arItems as $i => $arItem):?>
                        ...
                        <div class="sections-block__wrapper <?= $itemWrapperClasses ?>">
                            <div class="sections-block__item <?= $itemClasses ?>"
									...
									<? if ($bShowImage && $imageSrc):?>
                                        <span class="sections-block__item-image-wrapper <?= $imageWrapperClasses ?>">
											<? if ($bIcons && $nImageID):?>
                                                ...
                                                <? else:?>
                                                    <img src="<?= $imageSrc ?>" class="sections-block__item-image"
                                                         alt="<?= $arItem['NAME']; ?>"/>
                                                <? endif; ?>
                                            <? else:?>
                                                <img src="<?= $imageSrc ?>" class="sections-block__item-image"
