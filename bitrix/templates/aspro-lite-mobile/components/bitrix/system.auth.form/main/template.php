							...
							<div class="auth__bottom-btns">
								<div class="line-block line-block--align-normal line-block--16-vertical line-block--column flexbox--direction-column flexbox--justify-beetwen">
									<?if($arResult['PHONE_AUTH_PARAMS']['USE']):?>
										...
										<div class="line-block__item">
<!--												<a href="--><?php //=$arResult['AUTH_REGISTER_URL'];?><!--" rel="nofollow" class="btn btn-default btn-transparent btn-lg btn-wide auth__bottom-btn register" tabindex="6">--><?php //=GetMessage('AUTH_REGISTER_NEW')?><!--</a>-->
											<?endif;?>
										</div>
									<?else:?>
										<div class="line-block__item">
										...
										<?if(\Bitrix\Main\Config\Option::get('main', 'new_user_registration', 'N', NULL) == 'Y'):?>
											<div class="line-block__item">
											<!--noindex-->
<!--												<a href="--><?php //=$arResult["AUTH_REGISTER_URL"];?><!--" rel="nofollow" class="btn btn-default btn-transparent btn-lg btn-wide auth__bottom-btn" tabindex="6">-->
<!--													--><?php //=GetMessage("AUTH_REGISTER_NEW")?>
<!--												</a>-->
											<!--/noindex-->
											</div>
										<?endif;?>
...
<!--						</div>-->
				...
				$(document).ready(function(){
                    ...
                    document.querySelector(".auth__bottom-btns").addEventListener("click", (e) => {
                        window.captcha = true;
