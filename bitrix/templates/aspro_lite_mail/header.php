...
<html>
	...
	<body style="background: none;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;height: 100% !important;margin: 0;padding: 0;font-family: Arial, Helvetica;padding-right: 2px;min-width: 268px !important;">
		<div class="mail-wrap" style="width: 100%;max-width: 600px;margin: 60px auto;overflow: hidden;background: #ffffff;border-radius: 8px;border: 1px solid #ededed;">
			<center>
				<!-- top content -->
																			...
																			<tbody>
																				<tr>
																					<td valign="top" class="bxBlockPadding bxBlockContentImage" style="padding: 16px 32px;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;mso-line-height-rule: exactly;">
																						<a align="center" href="<?=$siteAddressFull?>" class="link_img_logo" style="display: inline-block;zoom: 1;vertical-align: middle;margin: 0;background: none;max-width: 139px;height: 33px;text-decoration: none;color: #5b7fff;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;mso-line-height-rule: exactly;word-wrap: break-word;">
				...
				<tbody>
					<tr>
						<td id="bxStylistBody" style="font-family: Arial, Helvetica;color: #222222;font-size: 16px;line-height: 22px;background: none;padding-top: 0px;padding-bottom: 0px;padding-right: 0px;padding-left: 0px;overflow: hidden;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;mso-line-height-rule: exactly;">
							<!-- content -->
